...
back-end разработчик любительского уровня. Могу писать полноценный <b>API</b>. В стеке: JS/TS. Пробовал и умею работать с:
1) БД — MongoDB, MySQL (В том числе SQL, ORM: Sequelize, Prisma, TypeORM)
2) Сервером — NestJS, Express, Fastify.
3) Контролем авторизации — JWT, passport.
4) Версиями — github, gitlab.
5) API телеграмма — telegraf   // node-telegram-node-api, grammy
6) Асинхронным и ОО программированием.
